...
<div class="well">
    ...
    {{  Form::open(array('route' => array('result.update', $result->id), 'method'=>'put')) }}
    ...
    <fieldset>
        ...
        <div class="form-group" style="display: none">
            ...
            {{--            <div class="col-lg-10">--}}
            {!! Form::text('id', $result->id, ['class' => 'form-control',]) !!}
        </div>
</div>
...
<div class="form-group">
    {!! Form::label('name', 'Mark:', ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-10">
        {!! Form::text('mark', $result->mark, ['class' => 'form-control']) !!}
    </div>
</div>
<!-- Text Area -->
